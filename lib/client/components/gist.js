...
var Gist = (function (_React$Component) {
  ...
  function Gist() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(Gist).apply(this, arguments));
  }
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ loadSGFFromGist: _actionCreators.loadSGFFromGist }, dispatch);
}

exports.default = Gist; //connect(mapStateToProps)(Gist);
